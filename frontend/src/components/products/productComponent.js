...
export default class productComponent extends Component {
    ...
    componentDidMount() {
        ...
        //     },
        //     function () {
        //         this.arrayholder = this.props.fruits;
        //     }
        // )

        //fetch data trực tiếp
        return fetch(urlGetListFruit, {
            method: 'GET',
            headers: {
    ...
    componentDidUpdate(nextProps) {
        ...
        // if(this.state.testLoading === true){
        ...
        //         }
        //     )
        //     console.log("dataSource update ", this.props.fruits)
        // }
        // console.log("update tesst ", this.props.fruits)
                ...
                <View style={{ flex: 0.1 }}>
                    ...
                    >
                        ...
                        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
                            <Text style={{ fontWeight: "bold", fontSize: 24, color: "white" }}>Sản Phẩm</Text>
                        </View>
